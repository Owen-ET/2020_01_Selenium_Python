#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2020/03/27 16:16
# @Author  : zc
# @File    : getVerification.py
...
class GetVerification(object):
    ...
    imgPath = "/Users/zhangc/Desktop/GitTest/2020Project/Python/MoneyManagement/common/img/img.png"
    driver = webdriver.Chrome("/Users/zhangc/Desktop/GitTest/2020Project/Python/MoneyManagement/common/chromedriver")
    ...
    def open(self):
        ...
        url = 'https://fms.17mine.net/#/login?redirect=%2Fdashboard'
        self.driver.get(url)
